...
from hr_payroll.report import report_payslip_details
...
del Service._services['report.paylip.details']

report_sxw.report_sxw('report.paylip.details', 'hr.payslip', 'l10n_cl_hr_payroll/report/report_payslip_details.rml', parser=payslip_details_report)
