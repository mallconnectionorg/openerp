...
class HeaderHTML(osv.osv):
    ...
    _columns = {
        ...
        # agregar campos de alto y ancho
        'custom_size' : fields.boolean('Custom size', help="It will be ignored the Paper size defined and just consider the sizes of width and height below."),
        'page_width': fields.float('Width (mm)'),
        'page_height': fields.float('Height (mm)'),
