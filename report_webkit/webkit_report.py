...
class WebKitParser(report_sxw):
    ...
    def generate_pdf(self, comm_path, report_xml, header, footer, html_list, webkit_header=False):
        ...
        # modificacion para permitir tamanio definido por el usuario
        if webkit_header.custom_size:
        ...
        # fin modificacion para permitir tamanio definido por el usuario
        count = 0
        milogger = logging.getLogger('report_webkit')
        milogger.warn(command)
